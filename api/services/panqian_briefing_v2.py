...
**[技术面]** RSI={rsi:.0f}（{RSI判断:超买/中性/超卖}），动量20日={mom20:+.1f}%，RPS-20={rps20:.0f}/RPS-60={rps60:.0f}（{RPS判断:强势/中等/偏弱}），MACD={macd判断}，价格位置={pos:.0f}%（{位置判断:低位/中位/高位}）
...
5. 报告末尾注明：数据来源：社媒信号 + 技术因子数据库 | 日期：{date}"""
