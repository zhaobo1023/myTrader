...
CREATE TABLE IF NOT EXISTS financial_income_detail (
    ...
    other_equity_instruments DOUBLE COMMENT 'perpetual bonds + preferred stock balance (yi)',
    other_equity_interest_payable DOUBLE COMMENT 'accrued interest on perpetual bonds (yi)',
    loan_provision_balance DOUBLE COMMENT 'loan loss provision balance (yi)',
    gross_margin_pct DOUBLE COMMENT 'gross margin pct (consumer)',
    selling_expense_ratio DOUBLE COMMENT 'selling expense ratio pct (consumer)',
    dealer_count DOUBLE COMMENT 'dealer/distributor count (consumer)',
    inventory_balance DOUBLE COMMENT 'inventory balance (yi)',
    contract_liabilities DOUBLE COMMENT 'contract liabilities (yi)',
    rd_expense_ratio DOUBLE COMMENT 'R&D expense ratio pct (manufacturing)',
    capacity_utilization DOUBLE COMMENT 'capacity utilization pct (manufacturing)',
    construction_in_progress DOUBLE COMMENT 'construction in progress (yi)',
