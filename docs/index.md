...
| 文档 | 说明 | 更新 | 大小 |
|------|------|------|------|
| [财报分析系统演进总结](financial_report_system_summary.md) | Phase 0-4 完整迭代记录、Qwen/Claude/f大对比分析、经验教训 | 2026-04-13 | 20KB |
...
| 文档 | 说明 | 更新 | 大小 |
|------|------|------|------|
| [myTrader 技术方案](myTrader_tech_plan.md) | 个人投研平台完整技术方案与任务拆解 | 2026-04-05 | 20KB |
